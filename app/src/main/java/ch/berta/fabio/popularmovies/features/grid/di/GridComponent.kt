...
/**
 * Defines the dependency injection component for the grid screen.
 */
@PerActivity
@Component(modules = arrayOf(GridViewModelFactoryModule::class), dependencies = arrayOf(ApplicationComponent::class))
interface GridComponent {

    val gridViewModelFactory: GridViewModelFactory
}