...
public abstract class MovieGridBaseFragment<T extends MovieGridViewModel, S extends MovieGridBaseFragment.ActivityListener>
    ...
    protected final void startDetailsActivity(@NonNull Intent intent, @NonNull View posterSharedElement) {
    ...
    protected final void replaceDetailsFragment(@NonNull MovieDetailsBaseFragment fragment) {
        getFragmentManager().beginTransaction()
